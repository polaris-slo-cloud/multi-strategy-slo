...
decision_yamls = [f'{subdir}/horizontal/workload_test.yaml', f'{subdir}/horizontal/slo-mapping_test.yaml']
vertical_yamls = [f'{subdir}/horizontal/workload_reference.yaml', f'{subdir}/horizontal/slo-mapping_reference.yaml']
